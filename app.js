...
servoSensibility = {'THUMB': 0, 'INDEX': 2, 'MIDDLE': 2, 'ANNULAR': 2, 'PINKIE': 2};
...
board.on("ready", function() {
	...
	// ANNULAR
	servoFinger['ANNULAR'] = new five.Servo({
		pin: 5, // Servo 3
		range: [0, 160], // Default: 0-180
		type: "standard", // Default: "standard". Use "continuous" for continuous rotation servos
		startAt: 0, // if you would like the servo to immediately move to a degree
				...
				// ELSE IF THE OBJECT IS VALID WE CAN PROCEED
					...
					for( var j = 0; j < detectedFingers; j++ ){
			        	...
			        	// LET'S MOVE THE SERVO IF THE SENSIBILITY THRESHOLD IS EXCEEDED
							...
							handToHand.moveFingerTo(servoFinger, fingerAngle, servo, oldServoAngles, servoSensibility, hand, this_finger);
			      		
						
						//if(tmp[0] < 0)
							//console.log("closeclosecloseclosecloseclosecloseclosecloseclose");
